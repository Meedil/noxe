...
export default function Navbar() {
  ...
  return (
    <nav
      className={`navbar navbar-expand${expansionBreakpoint} navbar-dark mb-lg-5`}
    >
          ...
          <>
            ...
            >
              <ul className="navbar-nav me-auto mb-lg-0">
                ...
                <li className="nav-item">
                  <Link className="nav-link" to="/discover/movie/1">
                    Movies
                  </Link>
                </li>
                <li className="nav-item">
              ...
              >
                ...
                />
                <button
                  className="btn btn-outline-success me-lg-3"
                  type="submit"
                >
                  Search
                </button>
