...
export default function MoviePage() {
  ...
  const genres = pageData.genres.map(({ id: genreId, name: genreName }) => {
    return (
      <div key={genreId} className="d-inline-block me-1 mb-1 genre-block">
        {genreName}
      </div>
    );
  });
    ...
    .map((member) => {
      return (
        <div className="cast-member">
          <div className="cast-member-img-crop mx-auto">
            <img
      ...
      <div className="row">
        <div className="col-sm-4">
          <img
            ...
            src={getImageURL(pageData.poster_path, "original")}
            alt=""
          />
        </div>
        <div className="col">
          ...
          <div className="my-2">
            <div className="fact-fields d-inline-block bg-dark py-1 px-2 mb-1 me-1">
              Release Date: {pageData.release_date}
            </div>
            <div className="fact-fields d-inline-block bg-dark py-1 px-2 mb-1 me-1">
              Runtime: {pageData.runtime} mins
            </div>
            <div className="fact-fields d-inline-block bg-dark py-1 px-2 mb-1 me-1">
              vote count: {pageData.vote_count}
            </div>
            <div className="fact-fields d-inline-block bg-dark py-1 px-2 mb-1 me-1">
              vote average: {pageData.vote_average}
            </div>
            <div className="fact-fields d-inline-block bg-dark py-1 px-2 mb-1 me-1">
          ...
          <div className="d-flex justify-content-around flex-wrap actors-container">
            {cast}
          </div>
        </div>
      </div>
