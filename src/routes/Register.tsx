    ...
    <form className="container" onSubmit={register}>
          ...
          <input
            ...
            onKeyDown={(e) => {
              if (e.key.toLowerCase() === "enter")
                (registerBtn.current as any).click();
            }}
          />
        </div>
      </div>
      {message && (
        <div className="div row">
          <div className="col-10 col-md-8 offset-1 offset-md-2 text-bg-danger bg-opacity-25 subtext fw-bold rounded py-2">
            {message}
          </div>
        </div>
      )}
      <div className="row mt-3">
        <button
          ref={registerBtn}
          className="btn bg-light btn-light col-4 col-md-2 offset-4 offset-md-5"
          type="submit"
        >
          Register
        </button>
      ...
      <div className="row justify-content-center">
        <div className="col-4 col-md-2 text-center mt-3">
